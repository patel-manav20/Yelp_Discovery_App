...
export default function LoginPage() {
  ...
  const returnTo = buildReturnPath(location.state?.from) || ROUTES.HOME;
    ...
    <div className="max-w-md mx-auto py-8 px-4">
      ...
      <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <Link to={ROUTES.SIGNUP} className="font-medium text-yelp-red hover:underline">
            Sign up
          </Link>
        </p>
        <p className="mt-2 text-center text-sm text-gray-500">
          Restaurant owner?{" "}
          <Link to={ROUTES.OWNER_LOGIN} className="text-yelp-red hover:underline">
            Owner login
          </Link>
        </p>
      </div>
